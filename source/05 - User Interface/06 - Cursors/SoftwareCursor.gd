...
@onready var item: Sprite2D = $Cursor_Textures/CursorAxis/CursorObject
@onready var item_area: CollisionPolygon2D = $Cursor_Textures/CursorAxis/CursorObject/Area_Backpack/CollisionPolygon2D
