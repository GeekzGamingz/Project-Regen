...
@onready var axis: Node2D = $Cursor_Textures/CursorAxis
@onready var object: Sprite2D = $Cursor_Textures/CursorAxis/CursorObject
@onready var object_area: CollisionPolygon2D = $Cursor_Textures/CursorAxis/CursorObject/Area_Containers/CollisionPolygon2D
